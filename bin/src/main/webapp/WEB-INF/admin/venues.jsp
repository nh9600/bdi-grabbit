				...
				$.ajax({
					...
					success : function(res) {
						...
						for (var idx of res.list) {
							...
							html += '<tr class="table-light" onclick="goView(' + idx.viNum + ')">';
							}else{
								html += '<tr class="table-secondary" onclick="goView(' + idx.viNum + ')">';
							}
							html += '<td class="checkBox"><input type="checkbox" name="checkValue" value="' + idx.viNum + '"></td>'
							html += '<td>' + idx.viNum +'</td>';
							html += '<td colspan="2" align="left">매장명 : ' + idx.viName + '<br>전화번호 : ' + idx.viTel + '<br>주소 : ' + idx.viAddr + '</td>';
							html += '<td></td>';
