...
<head>
    ...
    <link rel="stylesheet" href="/res/main_theme/css/bootstrap-slider.css">
    ...
    <script src="/res/main_theme/js/bootstrap-slider.js"></script>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav ">
                        ...
                        <li class="nav-item " data-page="menu">
                       	...
                       	<li class="nav-item " data-page="menu">
                            <a href="/app/grabit?page=order-status" class="nav-link js-scroll-trigger">
                                주문현황                               
                            </a>
                        </li>                                                
